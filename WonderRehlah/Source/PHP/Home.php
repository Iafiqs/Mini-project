    ...
    <body>
        ...
        <div class="container" style="height: 100%;">
                ...
                <div class="contain">
                    <div class="banner">
                      <h1>WonderRehlah</h1>
                      <p>Planning your memorable vacation starts here</p>

                      <button id="myButton1" class="btn-left" >Trip Planner</button>
                          <script type="text/javascript">
                              document.getElementById("myButton1").onclick = function () {
                                  location.href = "TripPlanner.php";
                              };
                          </script>

                      <button id="myButton2" class="btn-right" >Things to Do</button>
                          <script type="text/javascript">
